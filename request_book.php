...
<body>
    <div class="request-table">
        <div class="request-container">
            <h2 class="request-title">List of favorite Books</h2>
            <?php
                ...
                while($row=mysqli_fetch_assoc($q))
                {
                    ...
                    <div class='table-info'>
                        ...
                        <div>
                            ...
                            <small>Price: ";echo $row['price'];echo" MAD.</small><br>";?>
    ...
    <!-- <div class="footer">
        <div class="footer-row">
            ...
            <div class="footer-right">
                <h1>contact</h1>
                <p>alf sahel smaila aghzafIN<i class="fas fa-map-marker-alt"></i></p>
        ...
        <div class="social-links">
            ...
            <p>&copy; 2021 Copyright by ADAM AGHZAF</p>
        </div>
    </div> -->
    <?php
    if(isset($_GET['req']))
